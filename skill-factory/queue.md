...
- [ ] 2026-03-31 | P1 | /linear-slack-reporter | 自動查詢 Linear bug、整理成表格、發 Slack 通知 | linear-slack-bug-reporter | skx: 2026-03-31
- [ ] 2026-03-31 | P1 | /api-aggregation-notifier | 通用框架：多源 API 數據聚合 → 轉換表格 → Slack dispatch | api-aggregation-framework | skx: 2026-03-31
